...
///////////////////////////////////////////////////////////////////////////////
#include <engine/textures_array.h>
...
public:
   ...
   *
   * All textures configurations need to be at least 13 or nullptr, if nullpptr is setted the base.
   * The order is the same as Mesh::VertexMaterial taking only the texture_index vars
   *
  ...
  /**
   * @brief Gets the first free texture bind
   * This only applies to the engine so is a constant
   *
   * @return texture id bind
   */
  static u32 GetFirstFreeTextureBind();
  ...
  /**
   * @brief Loads a textures array from a files with wrapper and filter options specified.
   *
   * @param paths Paths to the texture file.
   * @param files_count Count of files_path.
   * @param wrapS Wrapping mode in S direction.
   * @param wrapT Wrapping mode in T direction.
   * @param minF Magnification filter (default: Linear).
   * @param magF Minimization filter (default: Linear).
   ...
   * @return Unique identifier of the loaded texture.
   */
  static TexturesArray::Id UploadTexturesArray(const std::string *paths, const size_t &files_count,
                                               TexturesArray::Wrap wrapS = TexturesArray::Wrap::Repeat, TexturesArray::Wrap wrapT = TexturesArray::Wrap::Repeat,
                                               TexturesArray::Filter minF = TexturesArray::Filter::Linear, TexturesArray::Filter magF = TexturesArray::Filter::Linear);
  ...
  /**
   * @brief Gets a pointer to the textures array using its unique identifier.
   *
   * @param index Unique texture identifier.
   *
   * @return Pointer to the corresponding texture or nullptr if not found.
   */
  static TexturesArray *GetTexturesArray(u32 index);
   ...
   */
  static void SetBasicShaderColor(Math::Vec4 color = 1.0f);
   ...
   */
  static void SetBasicShaderColor(f32 r = 1.0f, f32 g = 1.0f, f32 b = 1.0f, f32 a = 1.0f);
   ...
   */
  static Shader::Id UploadShader(const byte *fragment, const byte *vertex);
   ...
   */
  static Shader *GetShader(Shader::Id index);
  ...
  /**
   * @brief Checks collision between two entities represented as cubes.
   *
   * @param entity_1 The ID of the first entity.
   * @param entity_2 The ID of the second entity.
   *
   * @return true if collision is detected, false otherwise.
   */
  static boolean CheckCubeCollision(Entity::Id entity_1, Entity::Id entity_2);

  /**
   * @brief Checks collision between two entities represented as spheres.
   *
   * @param entity_1 The ID of the first entity.
   * @param entity_2 The ID of the second entity.
   *
   * @return true if collision is detected, false otherwise.
   */
  static boolean CheckSphereCollision(Entity::Id entity_1, Entity::Id entity_2);

  // static boolean CheckCapsuleCollision(Entity::Id entity_1, Entity::Id entity_2);

  /**
   * @brief Checks collision between two entities represented as complex shapes.
   *
   * @param entity_1 The ID of the first entity.
   * @param entity_2 The ID of the second entity.
   * 
   * @return true if collision is detected, false otherwise.
   */
  static boolean CheckCoplexCollision(Entity::Id entity_1, Entity::Id entity_2);
