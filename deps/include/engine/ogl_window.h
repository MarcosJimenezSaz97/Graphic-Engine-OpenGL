...
private:
  ...
  mutable s32 last_key_state_[348] = {0};    ///< Array to store the last state of each key.
  mutable s32 last_mouse_state_[7] = {0};    ///< Array to store the last state of each mouse button.
