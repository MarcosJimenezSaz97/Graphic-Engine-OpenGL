...
public:
   ...
   */
  void printElapsedTime(Precision precision, char *str = nullptr);
   ...
   */
  static inline void Delay(int milliseconds) { std::this_thread::sleep_for(std::chrono::milliseconds(milliseconds)); }
...
private:
  ...
  bool stopped_ = false; ///< Flag indicating whether the timer is stopped.
};
